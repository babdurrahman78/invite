...
export default function Step1({step, setStep}: IStep): JSX.Element {
  return (
    <div className="h-[510px]">
      <div className="bg-content border  border-container rounded-[8px] py-[32px] px-[48px]">
        <div className="flex flex-col gap-[20px]">
          <p>
            At this stage, you will be interviewed by an Artificial Intelligence
            named Vivi. The interview will be conducted interactively, where
            your spoken responses will be recorded and responded to by Vivi in
            text format.
          </p>
          <div className="flex gap-4 items-center">
            <Image src={"/check.png"} alt="check.png" width={26} height={26} />
            <p>
              Please ensure that you have a stable internet connection 📶 and
          ...
          <div>
            <div className="flex gap-4 items-center">
              ...
              />
              <p>
                Please make sure you are using a browser and device with the
