    ...
    if (INTERVIEW_PREPARATION[step]?.welcome) {
      return (
        <p className="text-[28px] leading-[34px] text-primaryDarker text-center font-bold">
          {INTERVIEW_PREPARATION[step]?.welcome} <br />{" "}
          {INTERVIEW_PREPARATION[1].title}
        </p>
      );
    } else {
      return (
        <p className="text-[28px] leading-[34px] text-primaryDarker text-center font-bold">
          {INTERVIEW_PREPARATION[step].title}
        </p>
      );
    }
  };
  ...
  return (
    <div className="w-full flex flex-col justify-center">
      <div className={`w-full grid grid-cols-6 gap-[2px]`}>
        ...
        ></div>
        <div
          className={`h-[8px] ${step + 1 >= 2 ? "bg-primary" : "bg-step"} `}
        ></div>
        <div
          className={`h-[8px]  ${step + 1 >= 3 ? "bg-primary" : "bg-step"}`}
        ></div>
        <div
          className={`h-[8px]  ${step + 1 >= 4 ? "bg-primary" : "bg-step"}`}
        ></div>
        <div
